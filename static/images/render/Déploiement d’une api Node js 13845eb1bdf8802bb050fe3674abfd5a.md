...
1. **Créer un compte Render**
    ...
    ![Capture d’écran 2024-11-07 231948.png](Capture_dcran_2024-11-07_231948.png)
...
2. **Connecter votre dépôt GitHub**
    ...
    ![Capture d’écran 2024-11-07 232458.png](Capture_dcran_2024-11-07_232458.png)
    

![Capture d’écran 2024-11-07 232430.png](Capture_dcran_2024-11-07_232430.png)

1. **Créer un nouveau service web**
    - Dans le tableau de bord Render, cliquez sur "New" puis sélectionnez "Web Service".
    
    ![Capture d’écran 2024-11-07 232313.png](Capture_dcran_2024-11-07_232313.png)
    
    - Choisissez le dépôt GitHub approprié et la branche que vous souhaitez déployer.
    
    ![Capture d’écran 2024-11-07 232340.png](Capture_dcran_2024-11-07_232340.png)
    
    ![Capture d’écran 2024-11-07 232623.png](Capture_dcran_2024-11-07_232623.png)
...
2. **Configurer les paramètres de déploiement**
    ...
    ![Capture d’écran 2024-11-07 234957.png](Capture_dcran_2024-11-07_234957.png)
    
3. **Déployer l'application**
    - Cliquez sur "Create Web Service". Render commencera à construire et déployer votre application.
    
    ![Capture d’écran 2024-11-07 235651.png](Capture_dcran_2024-11-07_235651.png)
    
    - Une fois le déploiement terminé, Render fournira une URL où votre application est accessible.
    
    ![Capture d’écran 2024-11-08 131624.png](Capture_dcran_2024-11-08_131624.png)
...
- Ajoutez vos variables d'environnement en spécifiant le nom et la valeur correspondante.
    ...
    ![Capture d’écran 2024-11-07 234934.png](Capture_dcran_2024-11-07_234934.png)
